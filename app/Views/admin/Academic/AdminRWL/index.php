    ...
    <div class="hero-settings animate__animated animate__fadeIn">
        <div class="row align-items-center">
            <div class="col-lg-8 animate__animated animate__slideInLeft">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-style2 mb-2">
                        ...
                        <li class="breadcrumb-item active text-white" aria-current="page">ตั้งค่าระบบประเมิน RWL</li>
                    </ol>
                </nav>
                <h2 class="fw-bold mb-2 text-white card-title-balanced">
                    <i class='bx bx-edit'></i>
                    <span>ตั้งค่าระบบประเมินการอ่าน คิดวิเคราะห์ และเขียน</span>
                </h2>
            ...
            <div class="col-lg-4 text-center d-none d-lg-block animate__animated animate__zoomIn">
                <i class='bx bx-book-reader text-white opacity-25' style="font-size: 8rem;"></i>
            </div>
        </div>
    </div>
        ...
        <div class="col-md-8">
            <div class="card settings-card animate__animated animate__fadeInUp" style="animation-delay: 0.1s;">
                <div class="card-body p-sm-5 p-4">
                    ...
                    <h5 class="fw-bold mb-4 d-flex align-items-center"><i class='bx bx-list-check me-2 text-emerald'></i> กำหนดค่าพื้นฐานของระบบ (RWL)</h5>
                ...
                <div class="card-body p-4">
                    ...
                    <ul class="list-unstyled mb-0">
                        <li class="mb-3 d-flex">
                            ...
                            <span class="small text-muted">ระบบประเมินการอ่าน คิดวิเคราะห์ และเขียน (RWL) จะใช้ ปีการศึกษา/ภาคเรียน นี้สำหรับบันทึกเกรด</span>
                        </li>
                        <li class="mb-3 d-flex">
                            <i class='bx bx-check-double text-success me-2 mt-1'></i>
                            <span class="small text-muted">คุณครูประจำชั้นจะสามารถประเมินนักเรียนได้เมื่อสถานะระบบเป็น "เปิดใช้งาน"</span>
                        </li>
                        <li class="d-flex">
                            <i class='bx bx-check-double text-success me-2 mt-1'></i>
                            <span class="small text-muted">ควรตรวจสอบความถูกต้องของภาคเรียนก่อนเริ่มเปิดให้มีการประเมิน เพื่อความถูกต้องของข้อมูล</span>
                        </li>
                    </ul>
                    
                    <div class="mt-4 p-3 rounded-3 bg-light border-start border-4 border-success">
                        <p class="mb-0 small text-dark fw-bold">ข้อมูลเสริม</p>
                        <p class="mb-0 x-small text-muted">ระบบจะแสดงรายชื่อนักเรียนตามชั้นเรียนที่ครูคนดังกล่าวเป็นครูประจำชั้นหรือมีสิทธิ์ประเมิน</p>
                    </div>
                </div>
            </div>
        </div>
